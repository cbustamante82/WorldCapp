  ...
  return (
    <div className="mx-auto max-w-2xl px-4 py-6 sm:py-8 flex flex-col items-center gap-6 sm:gap-8">
      ...
      <a
        ...
        className="flex w-full max-w-md items-center justify-center gap-3 rounded-xl px-5 py-3.5 text-sm font-bold text-white shadow-sm transition hover:opacity-90 active:scale-95"
